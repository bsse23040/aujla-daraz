...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        ...
        songUL.innerHTML += `<li>
                                ...
                                <div class="playnow">
                                    <span>Play Now</span>
                                    <img class="invert" height="22px" src="/img/playnow.svg" alt="play icon">
                                </div>
                             </li>`;
    }
    ...
    let array = Array.from(anchors);
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
                        ...
                        <img src="/songs/${folder}/cover.jpeg" alt="cover pic">
...
// main function
async function main() {
    songs = await getSongs('songs/Karan_Aujla');
    ...
    playWrapper.addEventListener("click", () => {
        if (currentSong.paused) {
            ...
            currentSong.pause();
            playWrapper.innerHTML = `<img id="play" src="/img/play.svg" alt="play">`;
        }
    });
